...
from users.views import UserViewSet, login_view, GuruViewSet, KaryawanViewSet, SiswaViewSet, dashboard_stats, get_available_users, UserProfileView
from django.conf import settings
from django.conf.urls.static import static
from fitur.views import GaleriViewSet
